...
public class EmployeeServiceImp implements EmployeeService {
    ...
    public List<EmployeeDTO> getAllEmployees() {
        ...
        return employees.stream().map(Employee::viewAsEmployeeDTO).toList();
    }
    ...
    @Override //create a new employee
    ...
    @Override
    @Transactional // delete employee by id
